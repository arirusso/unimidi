...
One of the following libraries is required based on what platform you're using.  It should install automatically with the unimidi gem.
...
Note that if you are using a more unusual configuration (such as 32-bit Snow Leopard) you may find that they all install automatically.
