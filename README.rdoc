...
* Supports IAC Driver/ internal MIDI patching on OSX
...
Testing is tricky when working with unknown hardware configurations, and any ideas on how to better do so are most welcome
